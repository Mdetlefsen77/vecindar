...
- **Envío de datos:** Ubicación GPS, usuario + unidad y marca de tiempo (_timestamp_).
...
- **Notificaciones:** En MVP vía email y notificaciones _push_ internas (Firebase opcional).
...
- **Visualización:** Mapa con puntos y/o mapa de calor (_heatmap_).
- **Filtros:** Por tipo de incidente y rango de fechas (7, 30 o 90 días).

### Implementación Técnica

- **Mapas:** OpenStreetMap + Leaflet.
- **Heatmap:** Plugin de Leaflet o _clustering_ (agrupamiento) para el MVP.
