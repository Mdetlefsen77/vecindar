    ...
    <>
      ...
      >
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <DialogPanel className="max-w-md w-full bg-white p-8 rounded-xl shadow-lg text-center space-y-6">
            ...
            <Description className="text-gray-600">
              ...
              administrador. Podés intentar iniciar sesión más tarde para ver
              si ya fue aprobada.
            </Description>
            <button
